...
Kirigami.Dialog {
    ...
    preferredHeight: root.selectedDesktopFile === "" ? Kirigami.Units.gridUnit * 28 : -1
    ...
    ColumnLayout {
        ...
        // Configuration view (shown after selecting an app)
        ColumnLayout {
            Layout.fillWidth: true
            Layout.fillHeight: true
            visible: root.selectedDesktopFile !== ""
            ...
            Controls.Button {
                ...
                text: i18n("Select different application")
